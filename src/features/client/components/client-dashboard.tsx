      ...
      <Card className="border-yellow-200 bg-yellow-50">
        <CardHeader>
          <CardTitle className="text-yellow-800">
            🧪 Test Notification (Test environment only - will remove after
            deployment)
          </CardTitle>
          <CardDescription className="text-yellow-700">
            ...
            <br />
            • If successful: Shows toast "Test notification created!" and
            automatically refreshes notification count
            <br />
            • If failed: Shows error toast with detailed information
            <br />
            • All logs are written to console for debugging
            <br />
            <strong>⚠️ Note:</strong> This button is only for testing and will
            be removed when deploying to production
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Button
