          ...
          {isSimpleView ? (
            ...
            <div className="grid grid-cols-1 xl:grid-cols-6 gap-4 sm:gap-6">
              <div className="xl:col-span-4">
                ...
                {/* Info Tabs - Responsive Design */}
                <div className="mt-6 sm:mt-8 relative z-30 -mx-4 sm:-mx-6 lg:-mx-8">
                  <Tabs defaultValue="basic" className="w-full px-4 sm:px-6 lg:px-8">
                    {/* Mobile: Grid Layout */}
                    ...
                    <div className="hidden sm:block">
                      <div className="relative w-full">
                        <div className="py-2" style={{scrollbarWidth: 'thin'}}>
                          <TabsList className="min-h-10 items-center bg-muted p-1 text-muted-foreground flex gap-2 justify-between px-4 py-3 rounded-xl border border-gray-200 shadow-md h-auto relative z-40 w-full" style={{minWidth: '100%'}}>
                            <TabsTrigger
                              value="basic"
