...
const ClientUserEnhancements = dynamic(async () => {
        ...
        <footer className="bg-black text-white">
          <div className="container mx-auto px-4 sm:px-6 py-12">
            ...
            <div className="mt-10 flex flex-wrap items-center justify-center gap-x-10 gap-y-6 opacity-90">
              <a href="https://www.paypal.com" target="_blank" rel="noreferrer" aria-label="PayPal" className="hover:opacity-100 opacity-90 transition-opacity">
                <img src="https://cdn.simpleicons.org/paypal/FFFFFF" alt="PayPal" className="h-6 w-auto" />
              </a>
              <a href="https://www.escrow.com" target="_blank" rel="noreferrer" aria-label="Escrow.com" className="hover:opacity-100 opacity-90 transition-opacity">
                <img src="https://www.escrow.com/images/escrow-logo-white.svg" alt="Escrow.com" className="h-6 w-auto" />
              </a>
              <a href="https://wise.com" target="_blank" rel="noreferrer" aria-label="Wise" className="hover:opacity-100 opacity-90 transition-opacity">
                <img src="https://cdn.simpleicons.org/wise/FFFFFF" alt="Wise" className="h-6 w-auto" />
              </a>
              <a href="https://razorpay.com" target="_blank" rel="noreferrer" aria-label="Razorpay" className="hover:opacity-100 opacity-90 transition-opacity">
                <img src="https://cdn.simpleicons.org/razorpay/FFFFFF" alt="Razorpay" className="h-6 w-auto" />
              </a>
            </div>
